...
- **라우팅 테이블(Routing Table)**
  ...
  - **라우팅(Routing)**
    ...
    ![인터넷 트래픽을 "인터넷 게이트웨이"로 라우팅하는 라우팅 테이블](/architecting-on-aws/5.png)
...
![API Gateway](/architecting-on-aws/23.png)
...
![Step Functions로 상태를 체크하여 각 단계별 Lambda 함수를 실행하는 애플리케이션 구축](/architecting-on-aws/24.png)
